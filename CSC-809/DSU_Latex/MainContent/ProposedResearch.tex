...
% I do not want to waste time editing a diagram for the billionth time
% 
% \begin{figure}[ht]
%   \centering
...
%     Protections & W\#/ACC pin used with Status Register Bits to protect specified memory regions and configure parts as read-only \\
